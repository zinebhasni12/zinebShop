...
<th scope="col" className="px-6 py-3 text-center">
                            ...
                            {cart.map((item, index) => (
                                <tr key={index}
                                    ...
                                    <td className="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                                        <span
                                            className=" text-md   dark:bg-gray-700 dark:text-gray-400">{parseInt(item.price * item.quantity)}Dr</span>
                                    </td>
                                     <td className="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                            ...
                            <tr>
                                ...
                                <td>
                                     <span
                                         className="text-lg font-bold text-black   dark:bg-gray-700 dark:text-white"> {parseInt(getTotalPrice())} Dr</span></td>
